...
import * as data from '../data-half-3';
import { Options } from 'ng5-slider';
@Component({
  selector: 'app-humidity-ratio-chart',
  templateUrl: './humidity-ratio-chart.component.html',
  styleUrls: ['./humidity-ratio-chart.component.scss']
})
export class HumidityRatioChartComponent implements OnInit {
      ...
      yAxes: [
        {
          ticks: {
            callback: function(val: number) {
              return val.toFixed(2) + ' kgwater/kgair';
            },
            stacked: true
          }
        }
  ...
  setChart() {
    ...
    for (const [index, item] of this.dataJSON.entries()) {
      if (
        ...
        this.dataHumidity.push(+item.humidityRatio);
      }
    }
    this.chartDatasets = [{ data: this.dataHumidity, label: 'Humidity Ratio' }];
  }
